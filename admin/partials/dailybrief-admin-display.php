...
<div class="wrap">
    ...
    class="nav-tab <?php echo $active_tab == 'display_options' ? 'nav-tab-active' : ''; ?>">Display Options</a>
    <a href="options-general.php?page=dailybrief&tab=preview"
    class="nav-tab <?php echo $active_tab == 'preview' ? 'nav-tab-active' : ''; ?>">Preview</a>
    ...
    <form method="post" name="cleanup_options" action="options.php">
        ...
        <label>Debugging :
            <label><input type="radio"
                          name="<?php echo $this->plugin_name; ?>[debug]" <?php echo( ( $options["debug"] == '1' ? 'checked' : '' ) ); ?>>
                On</label>
            <label><input type="radio"
                          name="<?php echo $this->plugin_name; ?>[debug]" <?php echo( ( ( $options["debug"] == '0' || empty( $options["debug"] ) ) ? 'checked' : '' ) ); ?>>
                Off</label>
            <br></label>
        <label>Include Table of Contents :
            <label><input type="radio"
                          name="<?php echo $this->plugin_name; ?>[include_toc]" <?php echo( ( $options["include_toc"] == '1' ? 'checked' : '' ) ); ?>>
                On</label>
            <label><input type="radio"
                          name="<?php echo $this->plugin_name; ?>[include_toc]" <?php echo( ( ( $options["include_toc"] == '0' || empty( $options["include_toc"] ) ) ? 'checked' : '' ) ); ?>>
                Off</label>
            <br> </label>
        <label>Local HREFs in TOC :
            <label><input type="radio"
                          name="<?php echo $this->plugin_name; ?>[include_toc_local_hrefs]" <?php echo( ( $options["include_toc_local_hrefs"] == '1' ? 'checked' : '' ) ); ?>>
                On</label>
            <label><input type="radio"
                          name="<?php echo $this->plugin_name; ?>[include_toc_local_hrefs]" <?php echo( ( ( $options["include_toc_local_hrefs"] == '0' || empty( $options["include_toc_local_hrefs"] ) ) ? 'checked' : '' ) ); ?>>
                Off</label>
            <br></label>
